...
const Home = () => {
  ...
  console.log("allInvoices in home: ", allInvoices);
  console.log("allProducts in home: ", allProducts);
  ...
  useEffect(() => {
    const fetchInvoices = async () => {
      ...
      try {
        ...
        console.log("res.data?.invoices in home: ", res.data?.invoices);
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.log("res.data?.products in home: ", res.data?.products);
